...
def model(state: State):
    """Here, we're using the LLM to generate a LinkedIn post with human
    ...
    Generate a structured and well-written LinkedIn post based on the
    given topic.
    ...
    response = llm.invoke(
        [
            SystemMessage(content="You are an expert LinkedIn contentwriter"),
    ...
    print(f"[model_node] Generated LinkedIn Post: {generated_linkedin_post}")
